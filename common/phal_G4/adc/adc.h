...
typedef enum { ADC_RES_12_BIT = 0b00, ADC_RES_10_BIT = 0b01, ADC_RES_8_BIT = 0b10, ADC_RES_6_BIT = 0b11 } ADCResolution_t;
...
typedef struct {
	...
	uint32_t rank;		  // order at which the channels will be polled, starting
						  // at 0
