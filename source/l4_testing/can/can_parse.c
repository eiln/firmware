...
void handle_rx_autocase(CanMsgTypeDef_t *msg_header)
{
	CanParsedData_t *msg_data_a = (CanParsedData_t *)&msg_header->Data;
...
void handle_rx_stale(void)
{
	CHECK_STALE(can_data.test_msg5_2.stale, sched.os_ticks, can_data.test_msg5_2.last_rx, UP_TEST_MSG5_2);
	CHECK_STALE(can_data.test_stale.stale, sched.os_ticks, can_data.test_stale.last_rx, UP_TEST_STALE);
}

void set_rx_filter(void)
{
